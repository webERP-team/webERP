...
$MenuItems['system']['Transactions']['Caption'] = array(_('Company Preferences'), _('System Parameters'), _('Users Maintenance'), _('Maintain Security Tokens'), _('Access Permissions Maintenance'), _('Page Security Settings'), _('Dashboard Configuration'), _('Currencies Maintenance'), _('Tax Authorities and Rates Maintenance'), _('Tax Group Maintenance'), _('Dispatch Tax Province Maintenance'), _('Tax Category Maintenance'), _('List Periods Defined'), _('Report Builder Tool'), _('View Audit Trail'), _('Geocode Maintenance'), _('Form Designer'), _('Web-Store Configuration'), _('SMTP Server Details'), _('Mailing Group Maintenance'));
$MenuItems['system']['Transactions']['URL'] = array('/CompanyPreferences.php', '/SystemParameters.php', '/WWW_Users.php', '/SecurityTokens.php', '/WWW_Access.php', '/PageSecurity.php', '/DashboardConfig.php', '/Currencies.php', '/TaxAuthorities.php', '/TaxGroups.php', '/TaxProvinces.php', '/TaxCategories.php', '/PeriodsInquiry.php', '/reportwriter/admin/ReportCreator.php', '/AuditTrail.php', '/GeocodeSetup.php', '/FormDesigner.php', '/ShopParameters.php', '/SMTPServer.php', '/MailingGroupMaintenance.php');
